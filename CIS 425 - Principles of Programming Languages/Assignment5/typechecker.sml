...
fun typeOf env (AST_ID s)          = lookup env s
  ...
  | typeOf env (AST_FUN (x,t1,e))  = ARROW(t1, typeOf (Env (update env x t1)) e)  (* INTRO rule: fun introduction/definition *)
  ...
  | typeOf env (AST_APP (e1,e2))   = (case (typeOf env e1, typeOf env e2) of      (* ELIM rule: application of function *)
